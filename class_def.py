        ...
        for i in range(len(self.points_sorted)-1):
            ...
            if i == 0 or i == 1 or i==len(self.points_sorted)-1 or i==len(self.points_sorted)-2:
                ...
                if i%2==0:
                    ...
                    __total_time+=self.point_point_dist(self.points_sorted[i],self.points_sorted[i+1])/v_straght
            '''
            if i != 0 or i == len(self.points_sorted)-2:
                if i%2==0:
                    __total_dist+=self.arc_dist(self.points_sorted[i],self.points_sorted[i+1])
                    __total_time+=self.arc_dist(self.points_sorted[i],self.points_sorted[i+1])/v_arc
                elif i%2==1:
...
def plot1():
    ...
    #ax.set(xlim=[-2, 6], ylim=[-2, 6], title='Coverage Route', ylabel='Y-Axis', xlabel='X-Axis')
    #a=[(1,1),(5,2),(7,2),(9,-2),(-1,-1)]               #trapezoid-like polygon!!!           index=2,error:l
    #a=[(2,1),(6,2),(7,4),(6,8),(4,7),(3,6),(1,4)]      #point-in-a-line check!!!            index=2,error:l and r
    #a=[(2,1),(6,2),(7,4),(6,8),(4,7),(3,6)]       #!!!divided by zero!!!                    index=2,error:0
    #a=[(2,1),(6,2),(7,4),(6,8),(4,7),(1,4)]       #!!!divided by zero!!!                    index=2,error:0
    #a=[(1,1),(5,2),(7,2),(9,-2)]
    #a=[(1,1),(5,4),(3,-4)] 
    #a=[(0,0),(1,1),(3,-1),(2,-2)]
    a=[(2,2),(5,2),(6,-1),(1,-3),(0,-1)]
    #a=[(-4,-2),(-2,-4),(3,-3),(5,1),(4,3),(2,5),(-1,6),(-2,6),(-4,5),(-5,2)]
    #a=[(6.64870,5.40517),(6.37516,6.49934),(1.05378,3.83866),(1.40548,2.78355)]
    #a=[(19.99,20.0),(0.0,20.0),(0.0,0.0),(19.99,0.0)]
    #a=[(19.999,20.0),(0,20),(0,0),(19.99999,-0.01)]
    #a=[(4.01615568420407, 7.008077842102034), (2.857410648193329, 1.2143526620483311), (4.212372085939189, 1.5530930214847967), (5.446392757380256, 7.723196378690128)]
    #a=[(14.5488,1.7658),(21.4962,3.4383),(29.4813,20.2185),(24.1992,29.9835),(21.1071,28.8492),(5.5770,17.0031)]
    #a=[(10.811735631023993, 8.112661377805802), (20.435873733020898, 28.337199853107116), (5.577, 17.003099999999996)]
    radius=0.6
    alpha=0.08
    b=zigzagarea(a)
    b.init(radius,alpha)
    ...
    mat=[[-3,-4],[3.2,-2.4]]
    print(b.min_width())
    #print(zigzagarea.point_line_dist((7,2),((-1,-1),(8,-2))))
    #print(zigzagarea.inv(b.base_vector()))
    print(b.isconvex())
    #print(zigzagarea.point_line_dist((3,0),((0,0),(5,5))))
    #print(b.min_width())
    c=b.base_vector()
    #print(zigzagarea.inv(mat))
    #d=zigzagarea.coord_trans(zigzagarea.inv(b.base_vector()),a)
    d=b.trans_solve()
    e=b.split()
    f=b.trans_desolve()
    g=b.point_sort(start_point) 
    print(b.time_cal(v_straight,v_arc))
    print(b.turning_cal())
    #print(f)
    print(g)
    #print(d)
    ...
    '''
    ax.arrow(x4[0],y4[0],x4[1]-x4[0],y4[1]-y4[0],width=0.04,head_width=0.25,head_length=0.35,length_includes_head=True,fc='b',ec='b')
    ax.arrow(x4[temp-2],y4[temp-2],x4[temp-1]-x4[temp-2],y4[temp-1]-y4[temp-2],width=0.04,head_width=0.25,\
...
def plot2():
    ...
    #a=[(2,2),(5,2),(6,-1),(1,-3),(0,-1)]                           
    #a=[(-4,-2),(-2,-4),(3,-3),(5,1),(4,3),(2,5),(-1,6),(-2,6),(-4,5),(-5,2)]
    #a=[(1,1),(3,2),(6,2),(7,0),(6,-2),(4,-2)]
    #a=[(19.99,20.0),(0.0,20.0),(0.0,0.0),(19.99,0.0)]
    #a=[(2,1),(6,2),(7,4),(6,8),(4,8),(2,6),(1,4)]
    #a=[(14.5488,1.7658),(21.4962,3.4383),(29.4813,20.2185),(24.1992,29.9835),(21.1071,28.8492),(5.5770,17.0031)]
    b=totalarea(a)
    b.min_width()
    b.base_vector()
    ab=b.trans_solve()
    b.area_sub(a,3,(0.25,0.25,0.5))
    c=b.area_split()
    radius=(0.5,0.35,0.4)
    alpha=(0.1,0.05,0.15)
    ...
    x1.append(ab[0][0])
    y1.append(ab[0][1])
    ax.set(ylabel='Y-Axis', xlabel='X-Axis')
    #ax.set(title='Coverage Route', ylabel='Y-Axis', xlabel='X-Axis')
    #plt.plot(x1,y1)
    ...
    for i in range(len(d)):
        ...
        ax.arrow(x3[i][0],y3[i][0],x3[i][1]-x3[i][0],y3[i][1]-y3[i][0],width=0.01,head_width=0.2,head_length=0.3,\
            length_includes_head=True,fc='b',ec='b')
        ax.arrow(x3[i][temp-2],y3[i][temp-2],x3[i][temp-1]-x3[i][temp-2],y3[i][temp-1]-y3[i][temp-2],width=0.01,head_width=0.2,\
...
#print(concavearea.inter([(3,4),(0,1)],[(3,0),(0,0)]))
